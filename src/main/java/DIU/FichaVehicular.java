...
public class FichaVehicular extends javax.swing.JInternalFrame {
 ...
 ReporteValorPagar reporte1 = new ReporteValorPagar();
    ...
    // Obtén la instancia de Menu
    Menu menu = new Menu();
    
    // Agrega el componente al escritorio utilizando el método de Menu
    menu.agregarComponenteAlEscritorio(reporte1);

    // Haz visible la ventana de reporte
